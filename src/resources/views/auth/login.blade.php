...
<head>
    ...
    <style>
        ...
        input[type="email"], input[type="password"] { width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box; font-size: 14px; }
        .btn-submit { width: 100%; padding: 12px; background-color: #1890ff; border: none; border-radius: 4px; color: white; font-size: 16px; font-weight: bold; cursor: pointer; transition: background 0.2s; }
        .btn-submit:hover { background-color: #40a9ff; }
        .error-list { color: #ff4d4f; margin-bottom: 20px; font-size: 14px; padding-left: 20px; }
        .links { text-align: center; margin-top: 20px; font-size: 14px; }
        .links a { color: #ff4d4f; text-decoration: none; }
    </style>
</head>
<body>
...
<div class="auth-container">
    ...
    <div class="links">
        <a href="/register">初めてご利用の方（会員登録）</a>
    </div>
</div>
